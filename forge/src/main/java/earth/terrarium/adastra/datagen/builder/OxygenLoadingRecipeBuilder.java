...
public class OxygenLoadingRecipeBuilder implements RecipeBuilder {
    ...
    public OxygenLoadingRecipeBuilder(QuantifiedFluidIngredient input, FluidHolder result) {
        this.input = input;
        this.result = result;
    }

    public OxygenLoadingRecipeBuilder cookingTime(int cookingtime) {
        this.cookingtime = cookingtime;
        return this;
    }

    public OxygenLoadingRecipeBuilder energy(int energy) {
        this.energy = energy;
        return this;
    }

    @Override
    public @NotNull OxygenLoadingRecipeBuilder unlockedBy(@NotNull String criterionName, @NotNull CriterionTriggerInstance criterionTrigger) {
        this.advancement.addCriterion(criterionName, criterionTrigger);
        return this;
    }

    @Override
    public @NotNull OxygenLoadingRecipeBuilder group(@Nullable String groupName) {
        return this;
    }
    ...
    public void save(@NotNull Consumer<FinishedRecipe> finishedRecipeConsumer, @NotNull ResourceLocation recipeId) {
        ...
        finishedRecipeConsumer.accept(new Result(
            ...
            this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/oxygen_loading/" + recipeId.getPath()))
        );
    }
    ...
    public record Result(
        ...
        public void serializeRecipeData(@NotNull JsonObject json) {
            OxygenLoadingRecipe.codec(id)
                .encodeStart(JsonOps.INSTANCE, new OxygenLoadingRecipe(id, cookingtime, energy, input, result))
